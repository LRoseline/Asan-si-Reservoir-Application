...
//        http.setConnectTimeout(10000);
        ...
        if (xml != null) {
            ...
            api.setTdate(voir[1].item(1).getFirstChild().getNodeValue());
            api.setTrate(voir[2].item(1).getFirstChild().getNodeValue());
            api.setTwlevel(voir[3].item(1).getFirstChild().getNodeValue());
